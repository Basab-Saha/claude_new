...
// Full store app details (name, header image, genres), cached since this
// data barely changes and both the recommender and library lookups need it.
async function getAppDetails(appid) {
  ...
  try {
    ...
    if (entry && entry.success && entry.data) {
      ...
      data = { name: `App ${appid}`, headerImage: null, genres: [] };
    }
  } catch (err) {
